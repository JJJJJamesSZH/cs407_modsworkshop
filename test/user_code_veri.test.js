 ...
 * 4. correct email and code but expired timestamp
 */

// test 1 correct combo
...
//     console.log("std: ", code_veri_std);
//     console.log("tu1: ", code_veri_testU_1);

//     // http call, check code_veri_testU_1, start instantly
//     setTimeout(function() {
//         // update the correct email-code combination
...
// test 2 wrong code, expect 202
// it('checking with wrong verification code', function(done) {
//     // Correct email/code combination
//     console.log("================== test 2 ===================");
//     const code_veri_std = {
//         email: 'code_veri_testU@purdue.edu',
...
//     // http call, check code_veri_testU_2, start instantly
//     setTimeout(function() {
//         // update the correct email-code combination
//         console.log("delete ROW");
//         email_code.deleteRow
